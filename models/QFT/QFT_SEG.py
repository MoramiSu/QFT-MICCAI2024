...
from datasets.segmentation_dataset import (BUSISegmentDataset,
                                            DDTISegmentDataset
                                           )
...
def cli_main():
    parser = ArgumentParser(
        "Finetuning of semantic segmentation task for QFT")
    parser.add_argument("--base_model", type=str,
                        default="resnet50", help="resnet50 or vit")
    parser.add_argument("--ckpt_path", type=str,
                        default="/home/sutongkun/VLPv2/QFT/data/ckpts/QFT/17/epoch=46-step=7801.ckpt")
    ...
    qft = QFT.load_from_checkpoint(args.ckpt_path, strict=False)
    # qft = QFT()
    # encoder = qft.img_encoder_q.model
